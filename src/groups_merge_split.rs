    ...
    for action in ev_nanobot_group_action.iter() {
        match action {
            NanobotGroupAction::Merge => {
                ...
                for (entity, children) in selected_groups.iter() {
                ...
                let mut new_ent = commands.spawn((NanobotGroup::default(), Selected {}));
            ...
            NanobotGroupAction::Split => {
                for (group_entity, children) in selected_groups.iter() {
                    ...
                    for i in 0..2 {
                        ...
                        let new_ent = &mut commands.spawn((NanobotGroup::default(), Selected {}));
