...
/// In-flight movement toward a world point with a stopping tolerance.
/// Exterior work uses `InteractionRegion` to choose this point and to validate
/// arrival and continuing work. Zero tolerance uses `STOP_THRESHOLD`.
