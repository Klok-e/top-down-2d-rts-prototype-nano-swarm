...
fn territory_snapshot_counts_each_owned_intent_cell_once_per_swarm() {
    ...
    app.world_mut().spawn((Swarm {}, opponent));
    {
        ...
        grid.paint_owned(IVec2::ZERO, IntentKind::Build, Some(SwarmId::PLAYER));
        grid.paint_owned(IVec2::ZERO, IntentKind::Corridor, Some(opponent));
        grid.paint(IVec2::new(4, 0), IntentKind::Defend);
    }
